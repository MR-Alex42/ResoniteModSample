...
namespace MySampleMod
{
    ...
    {
        private static IMySampleMod ModInstance;

        internal static void Apply(IMySampleMod instance)
        {
            ModInstance = instance;
            Harmony harmony = new Harmony("com.github.MR-Alex42.MySampleMod"); //typically a reverse domain name is used here (https://en.wikipedia.org/wiki/Reverse_domain_name_notation)
